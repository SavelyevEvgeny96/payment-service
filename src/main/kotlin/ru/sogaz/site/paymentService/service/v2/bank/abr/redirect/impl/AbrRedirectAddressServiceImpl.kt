...
class AbrRedirectAddressServiceImpl(
    ...
    companion object {
        private val unsuccessfulPaymentStatuses = setOf(
    ...
    override fun getRedirectView(id: String, status: String?): RedirectView =
        (id.toUuidOrNull()
    ...
    private fun buildStateRedirectUrl(id: UUID): String =
        "${apiConfigProperties.abrStateRedirectUrl.trimEnd('/')}/$id"
    ...
    private fun String.toFoundRedirectView(): RedirectView =
        RedirectView(this).apply { statusCode = HttpStatus.FOUND }
}
