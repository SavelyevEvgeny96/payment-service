...
class GetPaymentStatusDaoImpl(private val paymentStatusRepository: PaymentStatusRepository) :
    GetPaymentStatusDao {
    companion object {
    ...
    override fun getPaymentStatus(traceId: String, status: String): PaymentStatus {
        return try {
