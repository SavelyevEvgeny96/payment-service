...
class ConfigDataDaoImpl(private val configDataRepository: ConfigDataRepository) : ConfigDataDao {
    companion object {
        const val LOG_AND_ERROR_BANK_PRIORITY_NOT_FOUND = "Не найдено значение : "
    }

    private val logger = loggerFor(javaClass)
    override fun getBankInfoFromConfigData(traceId: String, valueNameInfo: String): String {
        val config =
            try {
