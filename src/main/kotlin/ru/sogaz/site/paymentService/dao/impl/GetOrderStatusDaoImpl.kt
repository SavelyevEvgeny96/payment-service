...
class GetOrderStatusDaoImpl(private val orderStatusRepository: OrderStatusRepository) : GetOrderStatusDao {
    private val logger = loggerFor(javaClass)
    override fun getOrderStatus(traceId: String, stateOrder: String): OrderStatus {
        return try {
