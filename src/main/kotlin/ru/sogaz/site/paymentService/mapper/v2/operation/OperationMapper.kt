...
abstract class OperationMapper {
    fun makePayOperation(
        ...
        when (idempotentOrderOperation.paymentType) {
            ...
            PaymentType.SBP -> when (idempotentOrderOperation.operationType) {
                ...
                OperationType.REGISTRATION -> TODO("SBP ${idempotentOrderOperation.operationType} is not implemented")
            }
        }
